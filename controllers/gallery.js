...
angular.module("galleryApp")
    .controller("visCtrl", function ($scope, $location) {
            ...
            $scope.data = {
                visuals: [
                    ...
                    {
                        name: "Visualizaiton #4",
                        description: "DESC of Vis #4",
                        category: "Google Chart",
                        createDate: "June 28, 2016"
                    },
                    {
                        name: "Visualizaiton #5",
                        description: "DESC of Vis #5",
                        category: "Google Chart",
                        createDate: "June 28, 2016"
                    }
                ]
